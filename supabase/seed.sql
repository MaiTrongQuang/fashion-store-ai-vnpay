...
INSERT INTO products (id, name, slug, description, category_id, brand_id, base_price, sale_price, is_featured, is_new, tags) VALUES
  ('p1000000-0000-0000-0000-000000000001', 'Áo Thun Basic Cotton', 'ao-thun-basic-cotton',
  ...
  ('p1000000-0000-0000-0000-000000000002', 'Áo Sơ Mi Oxford Slim Fit', 'ao-so-mi-oxford-slim-fit',
  ...
  ('p1000000-0000-0000-0000-000000000003', 'Quần Jean Skinny Wash', 'quan-jean-skinny-wash',
  ...
  ('p1000000-0000-0000-0000-000000000004', 'Áo Khoác Bomber Premium', 'ao-khoac-bomber-premium',
  ...
  ('p1000000-0000-0000-0000-000000000005', 'Đầm Midi Hoa Nhí', 'dam-midi-hoa-nhi',
  ...
  ('p1000000-0000-0000-0000-000000000006', 'Quần Tây Công Sở Regular', 'quan-tay-cong-so-regular',
  ...
  ('p1000000-0000-0000-0000-000000000007', 'Áo Thun Oversize Streetwear', 'ao-thun-oversize-streetwear',
  ...
  ('p1000000-0000-0000-0000-000000000008', 'Áo Polo Classic', 'ao-polo-classic',
...
INSERT INTO product_images (product_id, url, alt, is_primary, sort_order) VALUES
  ('p1000000-0000-0000-0000-000000000001', 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=800', 'Áo thun basic cotton trắng', TRUE, 0),
  ('p1000000-0000-0000-0000-000000000001', 'https://images.unsplash.com/photo-1622445275576-721325763afe?w=800', 'Áo thun basic cotton - mặt sau', FALSE, 1),
  ('p1000000-0000-0000-0000-000000000002', 'https://images.unsplash.com/photo-1596755094514-f87e34085b2c?w=800', 'Áo sơ mi Oxford trắng', TRUE, 0),
  ('p1000000-0000-0000-0000-000000000002', 'https://images.unsplash.com/photo-1603252109303-2751441dd157?w=800', 'Áo sơ mi Oxford - chi tiết', FALSE, 1),
  ('p1000000-0000-0000-0000-000000000003', 'https://images.unsplash.com/photo-1542272604-787c3835535d?w=800', 'Quần jean skinny wash', TRUE, 0),
  ('p1000000-0000-0000-0000-000000000004', 'https://images.unsplash.com/photo-1551028719-00167b16eac5?w=800', 'Áo khoác bomber', TRUE, 0),
  ('p1000000-0000-0000-0000-000000000005', 'https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?w=800', 'Đầm midi hoa nhí', TRUE, 0),
  ('p1000000-0000-0000-0000-000000000006', 'https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=800', 'Quần tây công sở', TRUE, 0),
  ('p1000000-0000-0000-0000-000000000007', 'https://images.unsplash.com/photo-1576566588028-4147f3842f27?w=800', 'Áo thun oversize streetwear', TRUE, 0),
  ('p1000000-0000-0000-0000-000000000008', 'https://images.unsplash.com/photo-1586363104862-3a5e2ab60d99?w=800', 'Áo polo classic', TRUE, 0);

-- Product Variants
INSERT INTO product_variants (product_id, size, color, color_hex, price, stock, sku) VALUES
  -- Áo Thun Basic Cotton
  ('p1000000-0000-0000-0000-000000000001', 'S', 'Trắng', '#ffffff', 249000, 50, 'ATBC-S-WHT'),
  ('p1000000-0000-0000-0000-000000000001', 'M', 'Trắng', '#ffffff', 249000, 80, 'ATBC-M-WHT'),
  ('p1000000-0000-0000-0000-000000000001', 'L', 'Trắng', '#ffffff', 249000, 60, 'ATBC-L-WHT'),
  ('p1000000-0000-0000-0000-000000000001', 'XL', 'Trắng', '#ffffff', 249000, 40, 'ATBC-XL-WHT'),
  ('p1000000-0000-0000-0000-000000000001', 'S', 'Đen', '#1a1a1a', 249000, 50, 'ATBC-S-BLK'),
  ('p1000000-0000-0000-0000-000000000001', 'M', 'Đen', '#1a1a1a', 249000, 90, 'ATBC-M-BLK'),
  ('p1000000-0000-0000-0000-000000000001', 'L', 'Đen', '#1a1a1a', 249000, 70, 'ATBC-L-BLK'),
  ('p1000000-0000-0000-0000-000000000001', 'M', 'Xám', '#6b7280', 249000, 45, 'ATBC-M-GRY'),
  -- Áo Sơ Mi Oxford
  ('p1000000-0000-0000-0000-000000000002', 'M', 'Trắng', '#ffffff', 599000, 30, 'ASMO-M-WHT'),
  ('p1000000-0000-0000-0000-000000000002', 'L', 'Trắng', '#ffffff', 599000, 25, 'ASMO-L-WHT'),
  ('p1000000-0000-0000-0000-000000000002', 'XL', 'Trắng', '#ffffff', 599000, 20, 'ASMO-XL-WHT'),
  ('p1000000-0000-0000-0000-000000000002', 'M', 'Xanh dương', '#3b82f6', 599000, 35, 'ASMO-M-BLU'),
  ('p1000000-0000-0000-0000-000000000002', 'L', 'Xanh dương', '#3b82f6', 599000, 30, 'ASMO-L-BLU'),
  -- Quần Jean Skinny
  ('p1000000-0000-0000-0000-000000000003', '29', 'Xanh đậm', '#1e3a5f', 559000, 40, 'QJS-29-DNV'),
  ('p1000000-0000-0000-0000-000000000003', '30', 'Xanh đậm', '#1e3a5f', 559000, 55, 'QJS-30-DNV'),
  ('p1000000-0000-0000-0000-000000000003', '31', 'Xanh đậm', '#1e3a5f', 559000, 50, 'QJS-31-DNV'),
  ('p1000000-0000-0000-0000-000000000003', '32', 'Xanh đậm', '#1e3a5f', 559000, 45, 'QJS-32-DNV'),
  ('p1000000-0000-0000-0000-000000000003', '30', 'Xanh wash', '#5b8fbe', 559000, 35, 'QJS-30-WSH'),
  -- Áo Khoác Bomber
  ('p1000000-0000-0000-0000-000000000004', 'M', 'Đen', '#1a1a1a', 749000, 25, 'AKB-M-BLK'),
  ('p1000000-0000-0000-0000-000000000004', 'L', 'Đen', '#1a1a1a', 749000, 30, 'AKB-L-BLK'),
  ('p1000000-0000-0000-0000-000000000004', 'XL', 'Đen', '#1a1a1a', 749000, 20, 'AKB-XL-BLK'),
  ('p1000000-0000-0000-0000-000000000004', 'M', 'Xanh rêu', '#4a5e3a', 749000, 20, 'AKB-M-GRN'),
  ('p1000000-0000-0000-0000-000000000004', 'L', 'Xanh rêu', '#4a5e3a', 749000, 25, 'AKB-L-GRN'),
  -- Đầm Midi Hoa Nhí
  ('p1000000-0000-0000-0000-000000000005', 'S', 'Hồng nhạt', '#fce4ec', 799000, 20, 'DMH-S-PNK'),
  ('p1000000-0000-0000-0000-000000000005', 'M', 'Hồng nhạt', '#fce4ec', 799000, 25, 'DMH-M-PNK'),
  ('p1000000-0000-0000-0000-000000000005', 'L', 'Hồng nhạt', '#fce4ec', 799000, 15, 'DMH-L-PNK'),
  ('p1000000-0000-0000-0000-000000000005', 'S', 'Xanh pastel', '#b2dfdb', 799000, 18, 'DMH-S-PST'),
  ('p1000000-0000-0000-0000-000000000005', 'M', 'Xanh pastel', '#b2dfdb', 799000, 22, 'DMH-M-PST'),
  -- Quần Tây Công Sở
  ('p1000000-0000-0000-0000-000000000006', '29', 'Đen', '#1a1a1a', 399000, 40, 'QTCS-29-BLK'),
  ('p1000000-0000-0000-0000-000000000006', '30', 'Đen', '#1a1a1a', 399000, 50, 'QTCS-30-BLK'),
  ('p1000000-0000-0000-0000-000000000006', '31', 'Đen', '#1a1a1a', 399000, 45, 'QTCS-31-BLK'),
  ('p1000000-0000-0000-0000-000000000006', '32', 'Đen', '#1a1a1a', 399000, 35, 'QTCS-32-BLK'),
  ('p1000000-0000-0000-0000-000000000006', '30', 'Navy', '#1e3a5f', 399000, 30, 'QTCS-30-NVY'),
  -- Áo Thun Oversize
  ('p1000000-0000-0000-0000-000000000007', 'M', 'Đen', '#1a1a1a', 349000, 60, 'ATO-M-BLK'),
  ('p1000000-0000-0000-0000-000000000007', 'L', 'Đen', '#1a1a1a', 349000, 70, 'ATO-L-BLK'),
  ('p1000000-0000-0000-0000-000000000007', 'XL', 'Đen', '#1a1a1a', 349000, 55, 'ATO-XL-BLK'),
  ('p1000000-0000-0000-0000-000000000007', 'M', 'Trắng', '#ffffff', 349000, 50, 'ATO-M-WHT'),
  ('p1000000-0000-0000-0000-000000000007', 'L', 'Trắng', '#ffffff', 349000, 65, 'ATO-L-WHT'),
  -- Áo Polo Classic
  ('p1000000-0000-0000-0000-000000000008', 'M', 'Trắng', '#ffffff', 449000, 35, 'APC-M-WHT'),
  ('p1000000-0000-0000-0000-000000000008', 'L', 'Trắng', '#ffffff', 449000, 40, 'APC-L-WHT'),
  ('p1000000-0000-0000-0000-000000000008', 'XL', 'Trắng', '#ffffff', 449000, 25, 'APC-XL-WHT'),
  ('p1000000-0000-0000-0000-000000000008', 'M', 'Navy', '#1e3a5f', 449000, 30, 'APC-M-NVY'),
  ('p1000000-0000-0000-0000-000000000008', 'L', 'Navy', '#1e3a5f', 449000, 35, 'APC-L-NVY');
