        ...
        <div className="flex flex-col animate-pulse">
            ...
            <section className="relative w-full h-[70vh] min-h-[500px] bg-muted/40">
                ...
                <div className="container mx-auto px-4 relative z-10 flex flex-col justify-center h-full max-w-2xl gap-4">
                    ...
                    <div className="h-12 w-3/4 rounded-lg bg-muted/80" />
                    <div className="h-12 w-1/2 rounded-lg bg-muted/80" />
            ...
            <section className="py-20 bg-background">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-12 space-y-3">
                        ...
                        <div className="h-10 w-64 rounded-lg bg-muted/60 mx-auto" />
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                        {Array.from({ length: 4 }).map((_, i) => (
                            <div
                                key={i}
                                className="aspect-4/5 rounded-lg bg-muted/40"
                            />
                        ))}
                    </div>
                </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-12 gap-6">
                        <div className="space-y-3">
                            ...
                            <div className="h-12 w-72 rounded-lg bg-muted/60" />
